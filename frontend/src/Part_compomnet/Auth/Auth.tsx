        ...
        <div className="grow h-full flex justify-center items-center">
                ...
                <CardContent>
                  <Form {...form}>
                    ...
                    >
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                type="password"
                                placeholder="영문숫자 포함 8자리 이상"
                                {...field}
                              />
                            </FormControl>
                            <p style={{ fontSize: "0.8em" }}>
                              ⚠️비빌번호는 수정이 불가하기 때문에 잘
                              암기해두시기 바람니다.
                            </p>
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="본인 학번 기재" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      />
                      <br />
                      <Button type="submit" className="singup w-full">
                        회원가입
                      </Button>
                    </form>
                  </Form>
          ...
          <AlertDialog open={Personal_information.result}>
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                <AlertDialogAction onClick={handleConfirm_Personal_information}>
                  확인
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
